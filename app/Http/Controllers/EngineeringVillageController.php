...
class EngineeringVillageController extends Controller {    
                                     
    public function import_json() {

        $query = null;
        $path_file = storage_path() . "/data_files/engineering_village/json/";
        $files = File::load($path_file);
        Util::showMessage("Start Import bibtex file from Engineering Village");
        try 
        {
            foreach($files as $file) 
            {
                ...
                foreach($articles as $key => $article) {
                    ...
                    $article["source"]          = Config::get('constants.source_engineering_village');
                    ...
                    $document = Document::where(
                        [
                            ...
                            ['file_name', '=', $file],
                            ['source', '=', Config::get('constants.source_engineering_village')],
                        ])
                        ->first();
        ...
        Util::showMessage("Finish Import bibtex file from Engineering Village");
    }
